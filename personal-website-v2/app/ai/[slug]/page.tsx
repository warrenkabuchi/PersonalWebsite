...
import { MapPin, Calendar, ArrowLeft, Cpu } from "lucide-react";
    ...
    return (
        <main className="min-h-screen bg-slate-950 text-slate-200 pt-16">
            ...
            <article className="max-w-4xl mx-auto px-4 md:px-8 -mt-32 relative z-10">
                <Link
                    href="/ai#insights"
                    className="inline-flex items-center gap-2 text-slate-400 hover:text-emerald-500 transition-colors mb-8"
                >
