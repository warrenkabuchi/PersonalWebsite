    ...
    <>
      ...
      <main className="min-h-screen bg-background text-foreground">
        ...
        <CalendlySection
          ...
          description="Let's discuss your project. Book a time that works for you."
          ...
          <div className="container max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-6">
              <a
                ...
                className="transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent rounded-sm"
                style={{ color: comicColors.muted.foreground }}
                aria-label="Visit Warren's GitHub profile"
              >
              ...
              <a
                ...
                className="transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent rounded-sm"
                style={{ color: comicColors.muted.foreground }}
                aria-label="Connect with Warren on LinkedIn"
              >
